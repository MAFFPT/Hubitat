...
## Introduction
These app and drivers were developed to overcome the lack of native support of the Nuki Smart Lock 2.0<sup>&copy;</sup> (https://nuki.io/en/) to the Hubitat Elevation<sup>&copy;</sup> environment.
