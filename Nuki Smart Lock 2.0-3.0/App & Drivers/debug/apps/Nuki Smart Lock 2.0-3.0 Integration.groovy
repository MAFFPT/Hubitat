...
@Field static _nukiDriverNameBridge = "Nuki Bridge for Lock 2.0/3.0" // name of the device type = driver name
...
@Field static _nukiAppName = "Nuki Smart Lock 2.0/3.0 Integration"   // This app

@Field static _nukiIntegrationVersion = "0.8.0"

@Field static _nukiDiscoverBridgesURL = "https://api.nuki.io/discover/bridges"

definition (name:              "Nuki Smart Lock 2.0/3.0 Integration",
